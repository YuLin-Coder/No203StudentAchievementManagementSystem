...
<body >
  ...
  <tr>
    ...
    <input class='btn btn-primary' type='button' value="添加新班级"  onclick="javascript:window.location.href='<%=basePath %>${url2 }add';"/>
&nbsp;&nbsp;&nbsp;&nbsp;
班级名称：<input name="bjname" type="text"  value="${bjname }">
